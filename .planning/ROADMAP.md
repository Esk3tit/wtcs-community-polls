...
**Plans**: 2 plans
Plans:
- [ ] 17-01-PLAN.md — Doc hygiene sweep (DOCS-05/06/07/08): VALIDATION frontmatter audit, 03-VERIFICATION retrospective + Subsequent evolution, SUMMARY requirements-completed backfill, v1.1 MILESTONES entry
- [ ] 17-02-PLAN.md — UI Card migration (UIDN-04/05): AdminsList + CategoriesList + PromoteAdminDialog hand-rolled containers → shadcn Card
**UI hint**: yes
...
| 17. Planning-Doc + UI Hygiene Sweep | 0/2 | Planned | - |
