-- ============================================================================
-- Phase 14 post-deploy production functiondef snapshot
-- Captured: 2026-05-17 via Supabase Studio SQL editor (project cbjspmwgyoxxqukcccjr)
-- Query source: same as W0 Check 3 (re-run after Migration 14 applied)
--
-- 6 entries — the 3-param update_profile_after_auth overload is GONE.
-- All 6 functions now carry `SET search_path TO ''`.
-- ============================================================================
